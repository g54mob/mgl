...
| `Rendering/FresnelHighlighter.cs`    | New                                   | `FresnelHighlighter.cs`                                     |
...
| `Core/GameEvents.cs`                 | **Modify**                      | Add:`OnToolSwitched`, `OnItemPickedUp`, `OnItemDropped` |
| `UI/UIManager.cs`                    | **Modify**                      | Add inventory panel check to `IsInAnyMenu()`                |
